...
class Conversation:
    ...
    @staticmethod
    def _create_message_param(role: Literal["user", "assistant", "system"], content: str) -> MessageParam:
        return MessageParam(
            role=role,
            content=content,
        )
    ...
    def send(self, user_message: str) -> str:
        ...
        text = next((cast(TextBlock, b).text for b in message.content if b.type == "text"), "")
